...
export class PrestamoFirestoreService {
    ...
    const docDef = {
      content: [
        ...
        },
        {
            //alignment: 'justify',
                fontSize: 12,
                text: `\nEste contrato de préstamo, se ejecuta a partir de ${documentData.prestamoDate}. \nEntre:`
        },
        {
            //alignment: 'justify',
                fontSize: 12,
                text: `${documentData.prestatarioName}, ubicado en ${documentData.prestatarioDirection}, en adelante denominado el "prestatario", cuya expresión, a menos que sea repugnante para el contexto, significará e incluirá a sus representantes legales, su cesionario, su(s) representante(s) y su administrador; \n Y:`
        },
        {
            //alignment: 'justify',
                fontSize: 12,
                text: `${documentData.prestamistaName}, ubicado en ${documentData.prestamistaDirection}, en adelante denominado el "prestamista", cuya expresión, a menos que sea repugnante para el contexto, significará e incluirá a sus representantes legales, cesionario, persona(s) designada(s) y administrador;`
        },
        {
            //alignment: 'justify',
                fontSize: 12,
                text: `\nMientras que a petición del Prestatario, el Prestamista ha acordado conceder un préstamo que no exceda la suma de ${documentData.prestamoQuantity} al Prestatario por un periodo de ${documentData.prestamoPeriod} en los términos y condiciones que se indican a continuación. \n\nLas partes acuerdan lo siguiente:`
        },
        {
          ul: [

              [{text: 'Cantidad del préstamo: ', bold: true},{text: `El Prestamista se compromete a prestar al Prestatario la suma principal de ${documentData.prestamoQuantity}, con fines ${documentData.prestamoPurpose}, y de acuerdo con los términos que se establecen a continuación.`}],
            ...
            [{text: 'Pago del préstamo: ', bold: true},{text: `El préstamo, junto con los intereses devengados y no pagados y todos los demás cargos, costos y gastos, vence y es pagadero en o antes de ${documentData.prestamoPeriod}.`}],
            [{text: 'Garantía: ', bold: true},{text: `${documentData.garanteName} ubicado en ${documentData.garanteDirection} promete garantizar incondicionalmente al prestamista, el pago completo y el cumplimiento por parte de ${documentData.prestatarioName} de todos los deberes y obligaciones que surjan bajo este contrato. ${documentData.garanteName} acepta que esta garantía permanecerá en pleno vigor y efecto, y será vinculante para el garante hasta que se cumpla este acuerdo.`}],
