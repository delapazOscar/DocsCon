    ...
    const docDef = {
      content: [
        ...
        },
        {
          columns: [
            {
              text: `${this.datosFactura.rfcCompany} \n ${this.datosFactura.companyName} \n ${this.datosFactura.companyNumber}`,
              bold: true,
              color: '#333333',
              //alignment: 'left',
            },
            {
              text: `${this.datosFactura.rfcClient} \n ${this.datosFactura.clientName} \n ${this.datosFactura.cfdiUse} \n ${this.datosFactura.clientNumber}`,
              bold: true,
              color: '#333333',
              //alignment: 'left',
            },
        ...
        },
        {
          columns: [
            {
              text: `${this.datosFactura.domicileCompany}, ${this.datosFactura.cpCompany}`,
              style: 'invoiceBillingAddress',
            },
            {
              text: `${this.datosFactura.domicileClient}, ${this.datosFactura.selectedState}`,
              style: 'invoiceBillingAddress',
            },
          ],
        },
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              [
                {
                  text: `${this.datosFactura.productDescription}`,
                ...
                {
                  border: [false, false, false, true],
                  text: `${this.datosFactura.productPrice}`,
                  fillColor: '#f5f5f5',
                  //alignment: 'right',
                  margins: [0, 5, 0, 5],
                },
